...
<div class="container">
 ...
 -->                        <!--  Local path -->
                    <a href="http://localhost:8080/BooksManagement" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-home"></span>
                        Take Me Home </a><a href="http://localhost:8080/BooksManagement" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-user"></span> User Login Page </a>
                </div>
            </div>
        </div>
    </div>
